...
//begin --lhc 2015年4月9日10:51:01
var hzcanvasOption;
var fxcanvasOption;
//end --lhc 2015年4月9日10:51:01
!function (e) {
    function t(e) {
        c(e, F) || (O[e] = 1)
    }
    ...
    function y(t) {
        ...
        function n() {
            if (r) {
                ...
                null == i && r.exports && (i = e, C(r.exports.split("."), function (e) {
                        return i = i[e],
                        !!i
                    })),
                o(t, s, i || {})
...
(this), define("echarts", ["echarts/echarts"], function (e) {
    ...
    return i.prototype = {
        _init : function () {
            ...
            this._toolbox = new m(this._themeConfig, this._messageCenter, i, {}, this),
        ...
        _render : function (t) {
            if (this._mergeGlobalConifg(t), !this._noDataCheck(t)) {
                ...
                for (var s, h, d, m = ["title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar"], c = 0, p = m.length; p > c; c++)
                    h = m[c], d = this.component[h], t[h] ? (d ? d.refresh && d.refresh(t) : (s = r.get(/^[xy]Axis$/.test(h) ? "axis" : h), d = new s(this._themeConfig, this._messageCenter, this._zr, t, this, h), this.component[h] = d), this._chartList.push(d)) : d && (d.dispose(), this.component[h] = null, delete this.component[h]);
                for (var u, V, U, g = {}, c = 0, p = t.series.length; p > c; c++)
                    V = t.series[c].type, V ? g[V] || (g[V] = !0, u = o.get(V), u ? (this.chart[V] ? (U = this.chart[V], U.refresh(t)) : U = new u(this._themeConfig, this._messageCenter, this._zr, t, this), this._chartList.push(U), this.chart[V] = U) : console.error(V + " has not been required.")) : console.error("series[" + c + "] chart type has not been defined.");
                for (V in this.chart)
        ...
        refresh : function (e) {
            ...
            e = e || {};
            var t = e.option;
            !this._refreshInside && t && (t = this.getOption(), o.merge(t, e.option, !0), o.merge(this._optionRestore, e.option, !0), this._toolbox.reset(t)),
            this._island.refresh(t),
            this._toolbox.refresh(t),
            this._zr.clearAnimation();
        ...
        addData : function (e, t, i, n, r) {
            function s() {
                if (X._zr) {
                    ...
                    for (var e = 0, t = v.length; t > e; e++)
                        v[e].motionlessOnce = h.addDataAnimation && v[e].addDataAnimation;
                ...
                if (p) {
                    ...
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        ...
                        if (p.type === a.CHART_TYPE_PIE && (y = d.legend) && (f = y.data)) {
                            ...
                            k,
                            L = p.xAxisIndex || 0;
                            (null == d.xAxis[L].type || "category" === d.xAxis[L].type) && (x = d.xAxis[L].data, k = h.xAxis[L].data, x[u](r), k[u](r), n || (x[V](), k[V]())),
                            L = p.yAxisIndex || 0,
                            "category" === d.yAxis[L].type && (x = d.yAxis[L].data, k = h.yAxis[L].data, x[u](r), k[u](r), n || (x[V](), k[V]()))
                        }
                    }
            ...
            for (var v = this._chartList, W = 0, w = function () {
                W--,
                0 === W && s()
            }, m = 0, c = v.length; c > m; m++)
                h.addDataAnimation && v[m].addDataAnimation && (W++, v[m].addDataAnimation(l, w));
        ...
        getConnectedDataURL : function (t) {
            ...
            for (var l in this._connected)
                i = this._connected[l].getDom(), n[l] = {
    ...
    function t(e) {
        return function () {
            for (var t = e.animatingElements, i = 0, n = t.length; n > i; i++)
                e.storage.mod(t[i].id);
    ...
    m.prototype.animate = function (e, t, a) {
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            var o;
            if (t) {
                for (var r = t.split("."), s = e, l = 0, h = r.length; h > l; l++)
                    s && (s = s[r[l]]);
                s && (o = s)
            } else
                o = e;
    ...
    m.prototype.stopAnimation = function (e) {
        if (e.__animators) {
            for (var t = e.__animators, n = t.length, a = 0; n > a; a++)
                t[a].stop();
            if (n > 0) {
    ...
    function t(e, t, n, a, o) {
        ...
        //begin lbt add 20150403
        canvasOption=this;
        if(canvasOption.dom.id=="jgxuehua")
            jgcanvasOption=this;
        if(canvasOption.dom.id=="fwrxuehua")
            zjcanvasOption=this;        
        //end lbt add 20150403
        //begin --lhc 2015年4月9日10:51:01
        if(canvasOption.dom.id=="xueshuxh")
            hzcanvasOption=this;
        if(canvasOption.dom.id=="xueshufx")
            fxcanvasOption=this;   
    ...
    return t.prototype = {
                ...
                if (t[n].show)
                    ...
                    case "magicType":
                        for (var a = 0, o = t[n].type.length; o > a; a++)
                            t[n].title[t[n].type[a] + "Chart"] = t[n].title[t[n].type[a]], t[n].option && (t[n].option[t[n].type[a] + "Chart"] = t[n].option[t[n].type[a]]), i.push({
                                key : n,
        ...
        getMagicOption : function () {
            ...
            if (this._defaultMagic(s.CHART_TYPE_CHORD, s.CHART_TYPE_FORCE), this._defaultMagic(s.CHART_TYPE_PIE, s.CHART_TYPE_FUNNEL), this._magicType[m] || this._magicType[c])
                for (var n = 0, a = this.option.series.length; a > n; n++)
                    this._magicType[m] ? (this.option.series[n].stack = "_ECHARTS_STACK_KENER_2014_", t = m) : this._magicType[c] && (this.option.series[n].stack = null, t = c), this._featureOption[t + "Chart"] && l.merge(this.option.series[n], this._featureOption[t + "Chart"] || {}, !0);
            return this.option
        },
    ...
    return t.prototype = {
        ...
        _getNearestDataIndex : function (e, t) {
            ...
            for (var h, m, c = this.component.grid.getY(), l = t.getCoordByIndex(i); l > c && (h = l, l >= a); )
                m = l, l = t.getCoordByIndex(++i);
            ...
            if (h.length > 0) {
                if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != m[0]) {
                    ...
                    if ("function" == typeof a) {
                        for (var x = [], g = 0, y = h.length; y > g; g++)
                            b = h[g].data[i], _ = this.getDataFromOption(b, "-"), x.push({
                                seriesIndex : m[g],
                                seriesName : h[g].name || "",
                                series : h[g],
                                dataIndex : i,
        ...
        _showPolarTrigger : function (e, t) {
            ...
            for (var h = this.option.polar[e].indicator[t].text, m = 0, c = o.length; c > m; m++)
                this._isSelected(o[m].name) && o[m].polarIndex === e && "axis" === this.deepQuery([o[m], this.option], "tooltip.trigger") && (a = this.query(o[m], "tooltip.showContent") || a, i = this.query(o[m], "tooltip.formatter") || i, n = this.query(o[m], "tooltip.position") || n, l += this._style(this.query(o[m], "tooltip")), r.push(o[m]), s.push(m));
            if (r.length > 0) {
                for (var p, u, V, U = [], m = 0, c = r.length; c > m; m++) {
                    p = r[m].data;
                    for (var g = 0, y = p.length; y > g; g++)
                        u = p[g], this._isSelected(u.name) && (u = null != u ? u : {
                                name : "",
                                value : {
                                    dataIndex : "-"
                                }
                ...
                if (this._lastItemTriggerId = -1, this._lastDataIndex != t || this._lastSeriesIndex != s[0])
                    if (this._lastDataIndex = t, this._lastSeriesIndex = s[0], "function" == typeof i)
                        ...
                        for (var m = 0, c = U.length; c > m; m++)
                            i = i.replace("{a" + m + "}", this._encodeHTML(U[m].seriesName)), i = i.replace("{b" + m + "}", this._encodeHTML(U[m].name)), i = i.replace("{c" + m + "}", this.numAddCommas(U[m].value)), i = i.replace("{d" + m + "}", this._encodeHTML(U[m].indicator));
                        this._tDom.innerHTML = i
                    } else {
                        i = this._encodeHTML(U[0].name) + "<br/>" + this._encodeHTML(U[0].indicator) + " : " + this.numAddCommas(U[0].value);
                        for (var m = 1, c = U.length; c > m; m++)
                            i += "<br/>" + this._encodeHTML(U[m].name) + "<br/>", i += this._encodeHTML(U[m].indicator) + " : " + this.numAddCommas(U[m].value);
                        this._tDom.innerHTML = i
                    }
        ...
        _styleAxisPointer : function (e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                ...
                for (var p in c)
                    c[p].color = d[p + "Style"].color, c[p].width = d[p + "Style"].width, c[p].type = d[p + "Style"].type;
                for (var u = 0, V = e.length; V > u; u++)
                    l = e[u], h = this.query(l, "tooltip.axisPointer.type"), m = h || m, h && (c[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || c[h].color, c[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || c[h].width, c[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || c[h].type);
                if ("line" === m) {
                    var U = c.line.width,
                    g = t == n;
                ...
                if (null != r) {
                    ...
                    if (d)
                        if (m) {
                            ...
                            case s.CHART_TYPE_K:
                                if (null == this.component.xAxis || null == this.component.yAxis || r.data.length <= c)
                                    return;
                            ...
                            case s.CHART_TYPE_RADAR:
                                if (null == this.component.polar || r.data[0].value.length <= c)
                                    return;
                            ...
                            case s.CHART_TYPE_SCATTER:
                                for (var c = e.dataIndex, a = 0, o = f.length; o > a; a++)
                                    if (null == f[a]._mark && l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                        this._curTarget = f[a],
                                        g = f[a].style.x,
                            ...
                            case s.CHART_TYPE_RADAR:
                                for (var c = e.dataIndex, a = 0, o = f.length; o > a; a++)
                                    if ("polygon" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                        this._curTarget = f[a];
                            ...
                            case s.CHART_TYPE_PIE:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)
                                    if ("sector" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "name") == b) {
                                        this._curTarget = f[a];
                            ...
                            case s.CHART_TYPE_MAP:
                                for (var b = e.name, k = r.mapType, a = 0, o = f.length; o > a; a++)
                                    if ("text" === f[a].type && f[a]._mapType === k && f[a].style._name === b) {
                                        this._curTarget = f[a],
                            ...
                            case s.CHART_TYPE_CHORD:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)
                                    if ("sector" === f[a].type && l.get(f[a], "name") == b) {
                                        this._curTarget = f[a];
                                        var _ = this._curTarget.style,
                                        x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                            ...
                            case s.CHART_TYPE_FORCE:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)
                                    if ("circle" === f[a].type && l.get(f[a], "name") == b) {
                                        this._curTarget = f[a],
    ...
    m.map = m.bar;
    for (var c in m)
        r.prototype.iconLibrary["legendicon" + c] = m[c];
    ...
    function h(e, t, i) {
        ...
        e = K(e),
        t = K(t);
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], c = e[2], p = e[3]; i > l; l++)
            n[l] = m([T(Math.floor(h), [0, 255]), T(Math.floor(d), [0, 255]), T(Math.floor(c), [0, 255]), p.toFixed(4) - 0], "rgba"), h += a, d += o, c += r, p += s;
        return h = t[0],
        d = t[1],
        c = t[2],
        p = t[3],
    ...
    function X(e, t, i) {
        ...
        i = 1 - T(i, [0, 1]);
        for (var n = 2 * i - 1, a = K(u(e)), o = K(u(t)), r = a[3] - o[3], s = ((n * r === -1 ? n : (n + r) / (1 + n * r)) + 1) / 2, l = 1 - s, h = [], d = 0; 3 > d; d++)
            h[d] = a[d] * s + o[d] * l;
        var c = a[3] * i + o[3] * (1 - i);
    ...
    return t.prototype = {
        ...
        _getChainPoint : function () {
            ...
            h = i.data,
            d = this._location.x,
            m = this._location.y + this._location.height / 4 * 3,
            c = this._location.x2 - this._location.x,
            p = h.length,
            u = [];
            if (p > 1) {
                var V = c / p;
                if (V = V > 50 ? 50 : 20 > V ? 5 : V, c -= 2 * V, "number" === i.type)
                    for (var U = 0; p > U; U++)
                        u.push(d + V + c / (p - 1) * U);
                else {
                    ...
                    for (var U = 1; p > U; U++)
                        u[U] = d + V + c * (new Date(e(U).replace(/-/g, "/")) - u[0]) / u[p - 1];
                    u[0] = d + V
                }
            } else
                u.push(d + c / 2);
            for (var g, y, f, b, _, x = [], U = 0; p > U; U++)
                d = u[U], g = h[U].symbol && h[U].symbol.toLowerCase() || n, g.match("empty") ? (g = g.replace("empty", ""), f = !0) : f = !1, g.match("star") && (y = g.replace("star", "") - 0 || 5, g = "star"), t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r, b = t.align || "center", o ? (b = o > 0 ? "right" : "left", _ = [o * Math.PI / 180, d, m - 5]) : _ = !1, x.push({
                    x : d,
                    n : y,
                    isEmpty : f,
                    symbol : g,
    ...
    t.prototype._start = function (e, t) {
        ...
        return setInterval(function () {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.y - c[i].animationY + n.r <= 0 && (c[i].highlightStyle.y = u + n.r, c[i].highlightStyle.x = Math.ceil(Math.random() * p)),
    ...
    t.prototype._start = function (e, t) {
        ...
        for (var h = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), m = s.x, c = s.y, p = s.r0 + 6, u = s.r - 6, V = s.color, U = a.lift(V, .1), g = new o({
                ...
                }), y = [], f = a.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), b = 15, _ = 240, x = 0; 16 > x; x++)
            y.push(new r({
                    highlightStyle : {
                        x : m,
                        y : c,
        ...
        if (null != i.progress) {
            ...
            e(g);
            for (var x = 0; 20 > x; x++)
                y[x].highlightStyle.color = k > x ? y[x]._color : U, e(y[x]);
            return e(h),
            void t()
        }
        return setInterval(function () {
            ...
            e(g);
            for (var i = 0; 20 > i; i++)
                y[i].highlightStyle.color = k > i ? y[i]._color : U, e(y[i]);
            e(h),
            t()
        }, s.timeInterval)
    },
    ...
    t.prototype._start = function (e, t) {
        ...
        for (var p = this.createBackgroundShape(i.backgroundColor), u = m.n, V = m.x, U = m.y, g = m.r0, y = m.r, f = m.color, b = [], _ = Math.round(180 / u), x = 0; u > x; x++)
            b[x] = new r({
                    highlightStyle : {
                        x : V,
                        y : U,
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function () {
        ...
        function p(e) {
            ...
            o,
            r;
            if (a = parseFloat(e[0]) / 360 % 360, 0 > a && a++, o = c(m(e[1]), 0, 1), r = c(m(e[2]), 0, 1), 0 == o)
                t = i = n = r;
            else {
        ...
        function V(e) {
            ...
            if (e = String(e), "#" == e.charAt(0))
                ...
                for (var n, a = d(e), t = "#", o = 0; 3 > o; o++)
                    n = -1 != a[o].indexOf("%") ? Math.floor(255 * m(a[o])) : +a[o], t += D[c(n, 0, 255)];
                i = +a[3]
            } else if (/^hsl/.test(e)) {
                var a = d(e);
                t = p(a),
        ...
        Q.drawImage = function (e) {
            ...
            if (e.runtimeStyle.width = h, e.runtimeStyle.height = d, 3 == arguments.length)
                t = arguments[1], i = arguments[2], o = r = 0, s = n = m, l = a = c;
            else if (5 == arguments.length)
                t = arguments[1], i = arguments[2], n = arguments[3], a = arguments[4], o = r = 0, s = m, l = c;
            else {
            ...
            if (u.push(" <g_vml_:group", ' coordsize="', J * V, ",", J * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                ...
                u.push("top:", T(p.y / J), "px;left:", T(p.x / J), "px;");
            u.push(' ">'),
    ...
    u = {
        ...
        click : function (e) {
            ...
            (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, m.CLICK, e),
        ...
        dblclick : function (e) {
            ...
            e = this._zrenderEventFixed(e);
            var t = this._lastHover;
            (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, m.DBLCLICK, e),
            this._mousemoveHandler(e)
        },
        ...
        mousemove : function (e) {
            if (!this.painter.isLoading()) {
                ...
                if (this._draggingTarget)
                    this.storage.drift(this._draggingTarget.id, t, i), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++;
        ...
        mousedown : function (e) {
            ...
            2 == this._lastDownButton ? (this._lastDownButton = e.button, void(this._mouseDownTarget = null)) : (this._lastMouseDownMoment = new Date, e = this._zrenderEventFixed(e), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, m.MOUSEDOWN, e), void(this._lastDownButton = e.button))
        },
        mouseup : function (e) {
            e = this._zrenderEventFixed(e),
            this.root.style.cursor = "default",
    ...
    function r(e, t, i, n, a, o, r, l, h) {
        ...
        if (1 == h)
            for (var m = 0; d > m; m++)
                l[m] = s(e[m], t[m], i[m], n[m], a, o, r);
        else
            for (var c = e[0].length, m = 0; d > m; m++)
                for (var p = 0; c > p; p++)
                    l[m][p] = s(e[m][p], t[m][p], i[m][p], n[m][p], a, o, r)
    }
    function s(e, t, i, n, a, o, r) {
        var s = .5 * (i - e),
        l = .5 * (n - t);
    ...
    return g.prototype = {
        when : function (e, t) {
            for (var i in t)
                this._tracks[i] || (this._tracks[i] = [], 0 !== e && this._tracks[i].push({
                        time : 0,
                ...
                if (U) {
                    ...
                    if (U) {
                        ...
                        for (var x = [], k = [], L = 0; U > L; L++) {
                            x.push(u[L].time / _);
                            var v = u[L].value;
                            "string" == typeof v && (v = m.toArray(v), 0 === v.length && (v[0] = v[1] = v[2] = 0, v[3] = 1), f = !0),
                            k.push(v)
                        }
                        var W,
                        L,
                        ...
                        var z = function (e, o) {
                            ...
                            if (0 !== d) {
                                if (w = (o - x[L]) / d, c)
                                    if (I = k[L], X = k[0 === L ? L : L - 1], K = k[L > U - 2 ? U - 1 : L + 1], S = k[L > U - 3 ? U - 1 : L + 2], y)
                                        r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                    else {
                                        var m;
                                    ...
                                    a(k[L], k[L + 1], w, l(e, V), b);
                                else {
                                    var m;
                                    f ? (a(k[L], k[L + 1], w, E, 1), m = h(E)) : m = n(k[L], k[L + 1], w),
                                    i(e, V, m)
                                }
                                for (L = 0; L < t._onframeList.length; L++)
                                    t._onframeList[L](e, o)
                            }
                        },
                        A = new d({
                                target : t._target,
    ...
    function i(e, t, i, o) {
        ...
        if ("undefined" != typeof s)
            return s;
        if (e.buildPath && L.isPointInPath)
            return a(e, L, t, i, o);
        switch (r) {
        case "ellipse":
            return !0;
    ...
    function s(e, t, i, n, a, o, r, s, l, h, d) {
        if (0 === l)
            return !1;
        var m = Math.max(l, 5);
        if (d > t + m && d > n + m && d > o + m && d > s + m || t - m > d && n - m > d && o - m > d && s - m > d || h > e + m && h > i + m && h > a + m && h > r + m || e - m > h && i - m > h && a - m > h && r - m > h)
            return !1;
    ...
    function b(e, i, n, a, o, r, s, l) {
        ...
        for (var m = 0, c = 0; 2 > c; c++) {
            ...
            if (p + e > s) {
                ...
                d = r ? 1 : -1;
                0 > u && (u = C + u),
                (u >= a && o >= u || u + C >= a && o >= u + C) && (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d), m += d)
            }
        }
        return m
    }
    function _(e, t, i, n, a) {
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            case "M":
                ...
                break;
            case "L":
                if (g && r(d, m, L[0], L[1], t, n, a))
                    return !0;
                _ && (o += U(d, m, L[0], L[1], n, a)),
                d = L[0],
                m = L[1];
                break;
            case "C":
                if (g && s(d, m, L[0], L[1], L[2], L[3], L[4], L[5], t, n, a))
                    return !0;
                _ && (o += y(d, m, L[0], L[1], L[2], L[3], L[4], L[5], n, a)),
                d = L[4],
                m = L[5];
                break;
            case "Q":
                if (g && l(d, m, L[0], L[1], L[2], L[3], t, n, a))
                    return !0;
                _ && (o += f(d, m, L[0], L[1], L[2], L[3], n, a)),
                d = L[2],
                m = L[3];
                break;
            case "A":
                ...
                var T = (n - v) * X / w + v;
                if (g && h(v, W, X, I, I + K, 1 - L[7], t, T, a))
                    return !0;
                _ && (o += b(v, W, X, I, I + K, 1 - L[7], T, a)),
                d = Math.cos(I + K) * w + v,
                m = Math.sin(I + K) * X + W;
                break;
            case "z":
                if (g && r(d, m, c, p, t, n, a))
                    return !0;
                u = !0
            }
        }
    ...
    function x(e, t) {
        ...
        for (var n = 0, a = 0, o = e.length; o > a; a++)
            n = Math.max(L.measureText(e[a]).width, n);
        return L.restore(),
        w[i] = n,
        ++I > S && (I = 0, w = {}),
        n
    ...
    function o(e, i, n, a, o, r) {
        ...
        if (t(m) && t(c))
            ...
            if (t(U)) {
                ...
                var L = (2 * m * l - 3 * s * c) / (2 * Math.sqrt(m * m * m)),
                v = Math.acos(L) / 3,
                W = Math.sqrt(m),
                w = Math.cos(v),
                V = (-l - 2 * W * w) / (3 * s),
                b = (-l + W * (w + g * Math.sin(v))) / (3 * s),
                X = (-l + W * (w - g * Math.sin(v))) / (3 * s);
                V >= 0 && 1 >= V && (r[u++] = V),
                b >= 0 && 1 >= b && (r[u++] = b),
                X >= 0 && 1 >= X && (r[u++] = X)
            }
    ...
    return i.prototype = {
        ...
        ondrop : function (e, t) {
            if (this.isDrop && e.target && !t.dragIn) {
                ...
                if (-1 === r) {
                    ...
                    for (var m = !1, c = s[o].data, u = 0, V = c.length; V > u; u++)
                        c[u].name === i.name && "-" === c[u].value && (s[o].data[u].value = i.value, m = !0);
                    !m && s[o].data.push(i),
        ...
        _buildMarkLine : function (e) {
            for (var t, i = (this.markAttachStyle || {})[e], n = this.series[e], a = U.clone(n.markLine), o = 0, r = a.data.length; r > o; o++) {
                ...
                !s.type || "max" !== s.type && "min" !== s.type && "average" !== s.type ? t = [this.getMarkCoord(e, s[0]), this.getMarkCoord(e, s[1])] : (t = this.getMarkCoord(e, s), a.data[o] = [U.clone(s), {}
                    ...
                    ], a.data[o][0].name = s.name || s.type, a.data[o][0].value = "average" !== s.type ? t[3] : +t[3].toFixed(null != a.precision ? a.precision : this.deepQuery([this.ecTheme, h], "markLine.precision")), t = t[2], s = [{}, {}
            ...
            if (m) {
                ...
                if (p) {
                    ...
                    U.merge(c.highlightStyle = {}, p.highlightStyle),
        ...
        _markPoint : function (e, t) {
            ...
            if (t.large)
                ...
                for (var b = 0, _ = u.length; _ > b; b++)
                    null != u[b].x && null != u[b].y && (r = null != u[b].value ? u[b].value : "", g && (o = g.getColor(i.name)), V && (o = isNaN(r) ? o : V.getColor(r), s = [u[b], t], l = this.deepQuery(s, "itemStyle.normal.color") || o, m = this.deepQuery(s, "itemStyle.emphasis.color") || l, null == l && null == m) || (o = null == o ? this.zr.getColor(e) : o, u[b].tooltip = u[b].tooltip || t.tooltip || {
                                trigger : "item"
        ...
        _markLine : function () {
            ...
            return function (i, n) {
                ...
                for (var m = n.data, c = [], p = this.zr.getWidth(), u = this.zr.getHeight(), g = 0; g < m.length; g++) {
                    ...
                    if (t(y[0]) && t(y[1])) {
                        ...
                        if (r) {
                            ...
                            L = this.deepQuery(b, "itemStyle.emphasis.color") || k;
                            if (null == k && null == L)
                                continue
                        }
                ...
                for (var w = [], g = 0, X = c.length; X > g; g++) {
                    ...
                    S = this.getMarkLineShape(n, i, y, g, I.points, v, K.color);
                    S._mark = "line";
        ...
        getSymbolShape : function (e, t, i, o, r, s, l, h, m, c, p) {
            ...
            null != g && (L.rotation = [g * Math.PI / 180, s, l]),
            h.match("star") && (L.style.iconType = "star", L.style.n = h.replace("empty", "").replace("star", "") - 0 || 5),
            "none" === h && (L.invisible = !0, L.hoverable = !1),
            L = this.addLabel(L, e, i, r, p),
            h.match("empty") && (null == L.style.textColor && (L.style.textColor = L.style.strokeColor), null == L.highlightStyle.textColor && (L.highlightStyle.textColor = L.highlightStyle.strokeColor)),
            d.pack(L, e, t, i, o, r),
            L._x = s,
            L._y = l,
            L._dataIndex = o,
        ...
        getMarkLineShape : function (e, t, i, n, a, r, l) {
            ...
            L = k.style;
            return r ? (L.pointList = a, L.smooth = _) : (L.xStart = a[0][0], L.yStart = a[0][1], L.xEnd = a[1][0], L.yEnd = a[1][1], L.curveness = _, k.updatePoints(k.style)),
        ...
        addShapeList : function () {
            ...
            if (this.option.animation && !this.option.renderAsImage && a.length < i && !this.motionlessOnce) {
                for (var m = 0, c = n.length; c > m; m++)
                    t = this._getAnimationKey(n[m]), t.match("undefined") ? this.zr.delShape(n[m].id) : (t += n[m].type, l[t] ? this.zr.delShape(n[m].id) : l[t] = n[m]);
                for (var m = 0, c = a.length; c > m; m++)
                    t = this._getAnimationKey(a[m]), t.match("undefined") ? this.zr.addShape(a[m]) : (t += a[m].type, d[t] = a[m]);
                for (t in l)
        ...
        animationEffect : function (e) {
            if (!e && this.clearEffectShape(), e = e || this.shapeList, null != e) {
                ...
                for (var i, n = 0, a = e.length; a > n; n++)
                    i = e[n], i._mark && i.effect && i.effect.show && c[i._mark] && (c[i._mark](this.zr, this.effectList, i, t), this.effectList[this.effectList.length - 1]._mark = i._mark)
            }
        },
    ...
    return t.prototype = {
        ...
        buildPath : function (e, t) {
            ...
            n = i.length;
            if (0 !== n)
                for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), m = i[0]instanceof Array, c = t.size ? t.size : 2, p = c, u = c / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                    e.beginPath(),
                    a = U * h,
                    o = a + h,
                    o = o > n ? n : o;
                    for (var g = a; o > g; g++)
                        if (t.random && (r = t["randomMap" + g % 20] / 100, p = c * r * r, u = p / 2), m ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p)
                            e.rect(s - u, l - u, p, p);
                        else
                            switch (t.iconType) {
                            case "circle":
            ...
            if (!(n.length < 2)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        ...
                        e.moveTo(n[0][0], n[0][1]);
                        for (var d = 1; o > d; d++)
                            a(e, n[d - 1][0], n[d - 1][1], n[d][0], n[d][1], m)
                    }
                } else {
                    e.moveTo(n[0][0], n[0][1]);
                    for (var d = 1; o > d; d++)
    ...
    function o(e, t, i, n, a) {
        ...
        "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, o, r], e.addShape(i), e.animate(i.id, "style").when(n, {
                ...
                i.__animating = !1
            }).start(a), e.animate(i.id, "").when(Math.round(n / 3 * 2), {
                rotation : [0, o, r]
    ...
    function t(e, t, i, n) {
        ...
        m = r.scaleSize,
        c = r.bounceDistance,
        p = "undefined" != typeof r.shadowBlur ? r.shadowBlur : m;
    ...
    function i(e, t, i, n) {
        ...
        for (var c = Math.round(100 * a.period), p = {}, u = {}, V = 0; 20 > V; V++)
            m.style["randomMap" + V] = 0, p = {},
        p["randomMap" + V] = 100,
        u = {},
        u["randomMap" + V] = 0,
            ...
            for (var c = new r(i, 4), p = [], u = l(), V = l(), U = 0, g = l(), y = l(), f = 0, h = 0; h < i.length; h++) {
                ...
                if (!d.group) {
                    ...
                    for (var b = 0, _ = null, x = null, k = 0; k < p.length; k++) {
                        var L = p[k],
                        v = 0;
                        L.group ? L.group !== x && (x = L.group, U = this._calculateGroupEdgeInk(L.group, d, u, V), v = L.group.ink + d.ink - U) : (U = this._calculateEdgeEdgeInk(d, L, u, V), v = L.ink + d.ink - U),
                        v > b && (b = v, _ = L, m(y, V), m(g, u), f = U)
                    }
                    if (_) {
                        s += b;
                        var W;
        ...
        buildPath : function (e, t) {
            ...
            if (o && !(2 > o)) {
                ...
                for (var V, U = 0, g = 2 * o - 1; g > U; U++)
                    V = U % 2 === 0 ? h : l, u.push([r + V * n(m), s + V * i(m)]), m += d;
                u.push([c, p]),
        ...
        buildPath : function (e, t) {
            ...
            if (!(o.length < 2)) {
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    for (var s, l, h, d = o.length, m = 0; d > m; m++)
                        s = r[2 * m], l = r[2 * m + 1], h = o[(m + 1) % d], e.bezierCurveTo(s[0], s[1], l[0], l[1], h[0], h[1])
                } else if ("spline" === t.smooth && (o = i(o, !0)), t.lineType && "solid" != t.lineType) {
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        var c = t._dashLength || (t.lineWidth || 1) * ("dashed" == t.lineType ? 5 : 1);
                        t._dashLength = c,
                        e.moveTo(o[0][0], o[0][1]);
                        for (var m = 1, p = o.length; p > m; m++)
                            a(e, o[m - 1][0], o[m - 1][1], o[m][0], o[m][1], c);
    ...
    n.prototype.nearestN = function (e, t, i, n) {
        ...
        for (a.data !== e && (d++, this._addNearest(d, h, a)), e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right)); r--; ) {
            ...
            c = !1;
            h *= h,
            (t > d || h < s[d - 1].dist) && (h = i(a.data, e), (t > d || h < s[d - 1].dist) && a.data !== e && (t > d && d++, this._addNearest(d, h, a)), c = !0),
    ...
    return t.prototype = {
        ...
        _contentToOption : function (e) {
            ...
            for (t = 0, o = m.length; o > t; t++)
                if (d++, m[t].type == n.CHART_TYPE_SCATTER)
                    for (var i = 0, a = m[t].data.length; a > i; i++)
                        s = e[d], l = s.replace(" ", "").split(","), "undefined" != typeof m[t].data[i].value ? m[t].data[i].value = l : m[t].data[i] = l, d++;
                else {
                    s = e[d].split(",");
                    for (var i = 0, a = m[t].data.length; a > i; i++)
                        l = (s[i] || "").replace(/.*:/, ""), l = this._trim(l), l = "-" != l && "" !== l ? l - 0 : "-", "undefined" != typeof m[t].data[i].value ? m[t].data[i].value = l : m[t].data[i] = l;
                    d++
                }
        },
        _trim : function (e) {
    ...
    h = function (e, t, i, n, o, h, d, m) {
        if (Math.abs(n - o) >= 2 * Math.PI)
            return d[0] = e - i, d[1] = t - i, m[0] = e + i, void(m[1] = t + i);
        ...
        for (var p = 0; o > p; p += Math.PI / 2)
            p > n && (l[0] = Math.cos(p) * i + e, l[1] = Math.sin(p) * i + t, a.min(d, l, d), a.max(m, l, m))
    };
    ...
    return t.prototype = {
        ...
        _getZoom : function () {
            ...
            for (var d, l = 0, h = e.length; h > l; l++)
                if (d = e[l], d.type == r.CHART_TYPE_LINE || d.type == r.CHART_TYPE_BAR || d.type == r.CHART_TYPE_SCATTER || d.type == r.CHART_TYPE_K) {
                    for (var m = 0, c = n.length; c > m; m++)
                        if (n[m] == (d.xAxisIndex || 0)) {
                            o.push(l);
                            break
                        }
                    for (var m = 0, c = a.length; c > m; m++)
                        if (a[m] == (d.yAxisIndex || 0)) {
                            o.push(l);
                            break
                        }
        ...
        _buildBackground : function () {
            ...
            for (var d = this._originalData.yAxis, m = this._zoom.yAxisIndex, l = 0, h = m.length; h > l; l++)
                i = Math.max(i, d[m[l]].length);
            for (var c, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++)
                c = this.getDataFromOption(u[l], 0), this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]), isNaN(c) && (c = 0), V = Math.max(V, c), U = Math.min(U, c);
            var g = V - U,
            y = [],
            f = e / (i - (i > 1 ? 1 : 0)),
            b = t / (i - (i > 1 ? 1 : 0)),
            ...
            for (var l = 0, h = i; h > l; l += _)
                c = this.getDataFromOption(u[l], 0), this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]), isNaN(c) && (c = 0), y.push("horizontal" == this.zoomOption.orient ? [this._location.x + f * l, this._location.y + t - 1 - Math.round((c - U) / g * (t - 10))] : [this._location.x + 1 + Math.round((c - U) / g * (e - 10)), this._location.y + b * (h - l - 1)]);
        ...
        _synScatterData : function (e, t) {
            ...
            for (var h, d = 0, m = t.length; m > d; d++)
                h = t[d].value || t[d], h[0] >= n && h[0] <= a && h[1] >= o && h[1] <= r && s.push(t[d]);
            return s
        },
        _setScale : function () {
    ...
    return t.prototype = {
                        ...
                        for (d = 1 > d ? 1 : d, e = Math.floor(15 / r); !h && n > e; ) {
                            ...
                            for (var m = Math.floor((n - 1) / e) * e; m >= 0; m -= e) {
                                if (0 !== this.option.axisLabel.rotate)
                                    o = t;
                                else if (i[m].textStyle)
                                    o = l.getTextWidth(this._getReformedLabel(m), this.getFont(s.merge(i[m].textStyle, this.option.axisLabel.textStyle)));
                                else {
        ...
        _buildAxisTick : function () {
            ...
            d = n.onGap,
            m = d ? this.getGap() / 2 : "undefined" == typeof d && this.option.boundaryGap ? this.getGap() / 2 : 0,
            c = m > 0 ? -h : 0;
            if (this.isHorizontal())
                for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = c; i > V; V += h)
                    (!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? m : 0), s), e = {
                            _axisShape : "axisTick",
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
                ...
                for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = c; i > V; V += h)
                    (!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? m : 0), s), e = {
                            _axisShape : "axisTick",
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
        ...
        _buildAxisLabel : function () {
            ...
            if (this.isHorizontal()) {
                ...
                for (var u = 0; a > u; u += this._interval)
                    m && !m(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {}, d), e = {
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase() + 3,
                            hoverable : !1,
                            style : {
        ...
        _buildSplitLine : function () {
            ...
            if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())
                for (var c, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)
                    (!h || h(V, t[V])) && (c = this.subPixelOptimize(this.getCoordByIndex(V) + m, r), e = {
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
                            style : {
                ...
                for (var U, g = this.grid.getX(), y = this.grid.getXend(), V = 0; i > V; V += this._interval)
                    (!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - m, r), e = {
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
                            style : {
        ...
        _buildSplitArea : function () {
            ...
            if (n instanceof Array) {
                ...
                if (this.isHorizontal())
                    for (var d, m = this.grid.getY(), c = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval)
                        s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h : this.grid.getXend(), e = {
                                zlevel : this.getZlevelBase(),
                                z : this.getZBase(),
                                hoverable : !1,
                                style : {
                    ...
                    for (var V, U = this.grid.getX(), g = this.grid.getWidth(), y = this.grid.getYend(), u = 0; r >= u; u += this._interval)
                        s && !s(u, t[u]) && r > u || (V = r > u ? this.getCoordByIndex(u) - h : this.grid.getY(), e = {
                                zlevel : this.getZlevelBase(),
                                z : this.getZBase(),
                                hoverable : !1,
                                style : {
    ...
    return t.prototype = {
        ...
        _buildAxisTick : function () {
            ...
            if (this.isHorizontal())
                for (var l, h = "bottom" === this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, d = 0; i > d; d++)
                    l = this.subPixelOptimize(this.getCoord(t[d]), s), e = {
                        _axisShape : "axisTick",
                        zlevel : this.getZlevelBase(),
                        z : this.getZBase(),
                        hoverable : !1,
            ...
            this.shapeList.push(new a(e));
                ...
                for (var m, c = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++)
                    m = this.subPixelOptimize(this.getCoord(t[d]), s), e = {
                        _axisShape : "axisTick",
                        zlevel : this.getZlevelBase(),
                        z : this.getZBase(),
                        hoverable : !1,
        ...
        _buildSplitLine : function () {
            ...
            var l = s.length;
            if (this.isHorizontal())
                for (var h, d = this.grid.getY(), m = this.grid.getYend(), c = 0; i > c; c++)
                    h = this.subPixelOptimize(this.getCoord(t[c]), r), e = {
                        zlevel : this.getZlevelBase(),
                        z : this.getZBase(),
                        hoverable : !1,
                        style : {
            ...
            this.shapeList.push(new a(e));
                ...
                for (var p, u = this.grid.getX(), V = this.grid.getXend(), c = 0; i > c; c++)
                    p = this.subPixelOptimize(this.getCoord(t[c]), r), e = {
                        zlevel : this.getZlevelBase(),
                        z : this.getZBase(),
                        hoverable : !1,
                        style : {
            ...
            if (t instanceof Array) {
                ...
                if (this.isHorizontal())
                    for (var r, s = this.grid.getY(), l = this.grid.getHeight(), h = this.grid.getX(), d = 0; a >= d; d++)
                        r = a > d ? this.getCoord(n[d]) : this.grid.getXend(), e = {
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
                            style : {
                ...
                h = r;
                    ...
                    for (var m, c = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++)
                        m = a > d ? this.getCoord(n[d]) : this.grid.getY(), e = {
                            zlevel : this.getZlevelBase(),
                            z : this.getZBase(),
                            hoverable : !1,
                            style : {
        ...
        _calculSum : function (e, t) {
            ...
            if (this.series[t].stack) {
                ...
                n = this.series[t].data;
                for (var h = 0, d = n.length; d > h; h++)
                    for (var m = n[h].evolution, c = 0, p = m.length; p > c; c++)
                        e[a].push(s.getNewDate(m[c].time))
            }
        },
        ...
        _reformLabelData : function (e) {
            ...
            if (t)
                ...
                for (var i = 0, n = this._valueList.length; n > i; i++)
                    this._valueLabel.push(s.format(e, this._valueList[i]));
            else
                for (var i = 0, n = this._valueList.length; n > i; i++)
        ...
        refresh : function (e, t) {
            e && (this.option = this.reformOption(e), this.option.axisLabel.textStyle = l.merge(this.option.axisLabel.textStyle || {}, this.ecTheme.textStyle), this.series = t),
    ...
    function a(e, i, n, a) {
        ...
        e = l.c,
        i = h.c;
        for (var m = (i - e) / n, c = t(a), p = 0, u = [], V = n + 1; V--; )
            u[V] = (e + m * V) * c;
        if (0 > a) {
            p = U(c),
            m =  + (m * c).toFixed(p),
    ...
    function d(e, i) {
        for (var n, a, o, r, s = [], h = _.length; h--; )
            n = _[h], a = l((i.c - e.c) / n, b), a = a.c * t(a.e), o = X(e.c / a) * a, r = I(i.c / a) * a, s[h] = {
                min : o,
                max : r,
                step : a,
                span : r - o

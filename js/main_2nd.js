...
//    }	
    ...
    $("#top").html('<div class="container"><div class="row"style="margin-top:10px;margin-left:10px;margin-right:10px;border-bottom:1px #fff solid;"><div class="col-xs-6"style="font-size:20px;color:#fff;">创新助手</div><div class="col-xs-6"style="height:28px;font-size:12px;color:#fff;text-align:right; vertical-align:text-bottom;">万方软件</div></div></div>');
    $("#bottom").html('<div class="b_nav"><a onclick="window.location.href=\'../index.html\';"><img src="../images/CXZS_bottom_ico1.png"></a><a onclick="location.reload();"><img src="../images/CXZS_bottom_ico2.png"></a><a onclick="history.go(-1);"><img src="../images/CXZS_bottom_ico3.png"></a><a onclick="window.location.href=\'../pages/user_dl.html\';"><img src="../images/CXZS_bottom_ico4.png"></a></div>');    
    
    $("#searchBtn").css("font-size", $("#main").width() / 14.5);
    //$("#bottom").find("img").css("width", ($("#main").width() / 14.5) * 2);
    $("#key").css({
        "height": ($("#main").width() / 14.5) * 2,
        "font-size": $("#main").width() / 14.5
    });
    //begin add lbt 20150410 隐藏底部导航
    $("#bottom").hide();
    //end add lbt 20150410
});
